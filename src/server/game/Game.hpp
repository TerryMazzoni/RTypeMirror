...
namespace Server {
    /**
     * @brief Class for the game gestion in the server
     */
    class Game {
        public:
            /**
             ...
             * @param server
             */
            void run(std::shared_ptr<UDPServer> server);
            /**
             ...
             * @param inputs
             */
            void updateGame(std::shared_ptr<UDPServer> server);
            /**
             ...
             * @param entity
             */
            void updateShips(std::shared_ptr<UDPServer> server, std::optional<Parser::entity_t> &entity);
            /**
             ...
             * @param entity
             */
            void updateColisions(std::shared_ptr<UDPServer> server, std::optional<Parser::entity_t> &entity);
            /**
             ...
             * @param entity
             */
            void updateEntities(std::shared_ptr<UDPServer> server, std::optional<Parser::entity_t> &entity);
            /**
             * @brief End the game.
             *
             */
             ...
             * @param server
             */
            void sendShips(std::shared_ptr<UDPServer> server);
            /**
             * @brief Send the bullets to the clients
             *
             * @param server
             */
            void sendBullets(std::shared_ptr<UDPServer> server);
            /**
             * @brief Send the bonus to the clients
             *
             * @param bonus
             */
            void sendBonus(std::shared_ptr<UDPServer> server);
            /**
             * @brief Send the id of an entity to delete to the clients
             *
             * @param server
             */
            void sendDelete(std::shared_ptr<UDPServer> server, int id);
            /**
